        ...
        >
          {filtered.map((project, index) => (
            <motion.article
              ...
              variants={fadeUp}
              whileHover={{ y: -8 }}
              className="group flex min-h-[360px] flex-col overflow-hidden rounded-lg border border-slate-200 bg-white/75 shadow-lg shadow-slate-900/5 backdrop-blur transition dark:border-white/10 dark:bg-white/[0.08]"
            >
              <div className={`relative h-36 bg-gradient-to-br ${accentClasses[project.accent]} p-5`}>
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-6 flex gap-3">
                  <a href={project.live} className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-slate-950 px-4 py-3 text-sm font-bold text-white transition hover:bg-cyan hover:text-ink dark:bg-white dark:text-ink dark:hover:bg-cyan">
